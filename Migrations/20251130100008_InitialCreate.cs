        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoringType = table.Column<int>(type: "int", nullable: false),
                    PenaltyFactor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamCodes_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedChoiceIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Description", "Key", "LastModified", "Value" },
                values: new object[,]
                {
                    { 1, null, "PlatformName", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2842), "PeP - Programming Examination Platform" },
                    { 2, null, "Version", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2846), "5.0" },
                    { 3, null, "Company", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2846), "Infinity Atom" },
                    { 4, null, "Copyright", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2847), "Copyright 2021 - 2025" },
                    { 5, null, "OpenAIApiKey", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2848), "" },
                    { 6, null, "DefaultExamDurationMinutes", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2848), "120" },
                    { 7, null, "EmailServer", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2849), "" },
                    { 8, null, "EmailPort", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2849), "587" },
                    { 9, null, "EmailUsername", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2850), "" },
                    { 10, null, "EmailPassword", new DateTime(2025, 11, 30, 10, 0, 8, 174, DateTimeKind.Utc).AddTicks(2850), "" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamCodes_Code",
                table: "ExamCodes",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamCodes_Code_ExpiresAt",
                table: "ExamCodes",
                columns: new[] { "Code", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ExamCodes_CreatedByUserId",
                table: "ExamCodes",
